      ...
      <v-layout class="background" fill-height column>
        ...
        <v-flex class="drawer-flex">  
            <v-list class="pt-0 pb-5" dense three-line>
              <ListTile :item="myWorld" :key="myWorld.title"/>
              <ListTile :item="myCode" :key="myCode.title"/>
              <ListTile :item="myFlag" :key="myFlag.title"/>
              <ListTile :item="myTimeline" :key="myTimeline.title"/>
              <ListGroup v-for="item in items" :item="item" :key="item.key"/>
              <ListTile :item="myContact" :key="myContact.title"/>
